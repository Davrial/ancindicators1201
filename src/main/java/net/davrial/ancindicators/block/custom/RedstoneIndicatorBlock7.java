...
public class RedstoneIndicatorBlock7 extends Block {
	...
	public RedstoneIndicatorBlock7(Properties pProperties) {
		super(pProperties);
	}
	...
	@Override
	public int getSignal(BlockState blockstate, BlockGetter blockAccess, BlockPos pos, Direction direction) {return 7;}
